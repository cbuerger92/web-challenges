...
// Funktionsaufrufe mit konkreten Werten
let resultAdd = add(5, 3); // 5 + 3 = 8
let resultSubtract = subtract(5, 3); // 5 - 3 = 2
let resultMultiply = multiply(5, 3); // 5 * 3 = 15
let resultDivide = divide(6, 3); // 6 / 3 = 2
let resultRemainder = remainder(7, 3); // 7 % 3 = 1

// Ausgaben der Ergebnisse in der Konsole
console.log(`Addition: ${resultAdd}`); // Ausgabe: Addition: 8
console.log(`Subtraktion: ${resultSubtract}`); // Ausgabe: Subtraktion: 2
console.log(`Multiplikation: ${resultMultiply}`); // Ausgabe: Multiplikation: 15
console.log(`Division: ${resultDivide}`); // Ausgabe: Division: 2
console.log(`Restwert: ${resultRemainder}`); // Ausgabe: Restwert: 1
