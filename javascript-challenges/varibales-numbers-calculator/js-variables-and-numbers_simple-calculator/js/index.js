...
divideButton.addEventListener("click", () => {
  ...
  // console.log("Operand 1:", operand1, "Operand 2:", operand2, "Division Result:", result);
  // console.log(result);
});
...
moduloButton.addEventListener("click", () => {
  ...
  const result = operand1 % operand2;
  // Log the variable's value to the console.
  console.log("Remainder or Modulus Result:", result);
});
...
increaseByOneButton.addEventListener("click", () => {
  // 7. Increase the value of "operand1" by 1.
  operand1 += 1;

  // Log the new value to the console.
  console.log("Increased Value of Operand1:", operand1);
});

increaseByFiveButton.addEventListener("click", () => {
  // 8. Increase the value of "operand1" by 5.
  operand1 += 5;
  // Log the new value to the console.
  console.log("Increased Value of Operand1:", operand1);
});
