...
const people = [
  {
    ...
    otherFriends: ["Barney Gumble", "Carl Carlson", "Lenny Leonard"],
    color_cloth: "white",
  },
...
const nameOfFirstPerson = people[0].name; // > speichert den Namen der ersten Person ("Homer") in der Variablen "nameOfFirstPerson"
// people[0] > das erste Element im Array people
// .name > die name-Eigenschaft dieses Objekts ("Homer")
...
const homersOtherFriends = people[0].otherFriends;
