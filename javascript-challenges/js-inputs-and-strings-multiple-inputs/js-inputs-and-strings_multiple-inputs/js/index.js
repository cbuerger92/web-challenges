...
switchValueButton.addEventListener("click", () => {
  // Wert des ersten Eingabefelds in einer temporären Variable speichern
  const tempValue = firstSwitchValueInput.value;
  // Wert des zweiten Eingabefelds in das erste Eingabefeld kopieren
  firstSwitchValueInput.value = secondSwitchValueInput.value;
  // Wert der temporären Variable (ursprünglicher Wert des ersten Eingabefelds) in das zweite Eingabefeld kopieren
